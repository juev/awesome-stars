...
- [dagu-org/dagu](https://github.com/dagu-org/dagu) – A versatile workflow orchestration engine for scheduling tasks, running containers, and remote execution. Single binary with Web UI. It can create complex workflows and run arbitrary commands or scripts on a schedule.
